...
import saar.ui.CommandLineArgs;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public Graph<Agent, Link> getFriends() {
	...
	public int getPrimaryRiskType() {
		return primaryRiskType;
	}

	public void setPrimaryRiskType(int newRiskType) {
		primaryRiskType = newRiskType;
	}

	public int getConnectedNeighbours() {
		return connectedNeighbours;
	}

	public void setConnectedNeighbours(int ConnectedNeighbours) {
	...
	public void setWattsBeta(double WattsBeta) {
		this.beta = WattsBeta;
	}
	...
	public String getOpinionDynamic() {
		return opinionDynamic;
	}
	...
	public DoubleBag getObjectiveRisks() {
		return objectiveRisks;
	}

	public void setObjectiveRisks(DoubleBag objectiveRisk) {
		this.objectiveRisks = objectiveRisk;
	}
	...
	protected void init() {
		...
		directedGraphFactory = new Supplier<DirectedGraph<Agent, Link>>() {
			public DirectedGraph<Agent, Link> get() {
				return new DirectedSparseMultigraph<Agent, Link>();
			}
		};

		final Saar model = this;
		...
		edgeFactory = new Supplier<Link>() {
			...
			public Connection get() {
				return new Connection(count++, Connection.DIRECTED);
			}
		};
